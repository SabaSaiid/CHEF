...
2. **Spoonacular Demo Data**: Recipe structures and images were adapted from open recipe APIs and cached locally. A unified dataset (`recipes.json`, ~310 KB, 360 recipes) provides broad coverage of Indian regional cuisines (Bihar, North Indian, South Indian) plus snacks, non-veg, and desserts.
