...
DEMO_RECIPES = [
    # ── Bihar / Eastern India ──
    RecipeItem(id="r-1", title="Litti Chokha", image_url="https://images.unsplash.com/photo-1645177628172-a94c1f96e6db?w=400", video_url = "https://www.youtube.com/embed/e6Tl_sAEkNU?si=E85lZ7StfWQwJyw0",
    ...
    RecipeItem(id="r-2", title="Sattu Paratha", image_url="https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400", video_url = "https://www.youtube.com/embed/hoDFK1rxUrA?si=4OdvSAb4_JBMlseJ",
    ...
    RecipeItem(id="r-3", title="Dal Chawal", image_url="https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400", video_url = "https://www.youtube.com/embed/Ip6IbWSgJQU?si=vPbkmsB5Gyk1TaGi",
    ...
    RecipeItem(id="r-4", title="Aloo Gobi", image_url="https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400", video_url = "https://www.youtube.com/embed/PhgyyJE90w8?si=lR82B-BriG-knWYJ",
    ...
    RecipeItem(id="r-5", title="Chana Masala", image_url="https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400", video_url = "https://www.youtube.com/embed/zl8ShZmaaRg?si=eFZIA1E6YXL6nTMw",
    ...
    RecipeItem(id="r-6", title="Paneer Tikka", image_url="https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400", video_url = "https://www.youtube.com/embed/c-oVDb-O2Q8?si=-2UQ54W49WbW4rSG",
    ...
    RecipeItem(id="r-7", title="Palak Paneer", video_url = "https://www.youtube.com/embed/BnYVJr-zZW4?si=oSVQH-imazlpyZ55",
    ...
    RecipeItem(id="r-8", title="Rajma Chawal", image_url="https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400", video_url = "https://www.youtube.com/embed/4TAmm-6YE4Y?si=3w64560skJYMM87s",
    ...
    RecipeItem(id="r-9", title="Chole Bhature", image_url="https://images.unsplash.com/photo-1626132647523-66f5bf380027?w=400", video_url = "https://www.youtube.com/embed/aFzBnNWEu5Y?si=63dOPFSNL0tMZSfD",
    ...
    RecipeItem(id="r-10", title="Dahi Vada", image_url="https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400", video_url = "https://www.youtube.com/embed/Z8agJbKKNTM?si=8Eme_JbKUMF1njiV",
    ...
    RecipeItem(id="r-11", title="Butter Chicken", image_url="https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400", video_url = "https://www.youtube.com/embed/u1sMNSw1vYY?si=qgmECidMRQYuJwuS",
    ...
    RecipeItem(id="r-12", title="Aloo Paratha", image_url="https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400", video_url = "https://www.youtube.com/embed/j3pDXY9fqSo?si=zS8cwCSyfqPxb-Gh",
    ...
    RecipeItem(id="r-13", title="Matar Paneer", video_url = "https://www.youtube.com/embed/SbOA2GcJOf0?si=UMR9KRT3vAShLazK",
    ...
    RecipeItem(id="r-14", title="Dal Makhani", image_url="https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400", video_url = "https://www.youtube.com/embed/mA5XjhdwJHc?si=keNQYlnfNcNxcFA1",
    ...
    RecipeItem(id="r-15", title="Biryani", image_url="https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=400", video_url = "https://www.youtube.com/embed/gYE9zOmJwsg?si=N-V4m7d68nLB5oyT",
    ...
    # ── South Indian ──
    RecipeItem(id="r-16", title="Masala Dosa", image_url="https://images.unsplash.com/photo-1630383249896-424e482df921?w=400", video_url = "https://www.youtube.com/embed/rJSICjc5s84?si=2T89lP2BKspcL0Ie",
    ...
    RecipeItem(id="r-17", title="Sambar", image_url="https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400", video_url = "https://www.youtube.com/embed/XvvObytWWSc?si=mK_YGXnkceHZSLP4",
    ...
    RecipeItem(id="r-18", title="Idli Sambar", video_url = "https://www.youtube.com/embed/OcQzvr91ob0?si=K6cn3_zfN06CmZE5",
    ...
    RecipeItem(id="r-19", title="Coconut Rice", video_url = "https://www.youtube.com/embed/8bVf6NeQJkk?si=tK6SRTHrxqNYAiLn",
    ...
    RecipeItem(id="r-20", title="Upma", video_url = "https://www.youtube.com/embed/zpMqTRadZXM?si=NjMNHMkgHNoBgwc",
    ...
    # ── Snacks & Street Food ──
    RecipeItem(id="r-21", title="Pav Bhaji", image_url="https://images.unsplash.com/photo-1606491956689-2ea866880049?w=400", video_url = "https://www.youtube.com/embed/Kt4d1JoPiOo?si=iHWdZwmSCV28bHHY",
    ...
    RecipeItem(id="r-22", title="Samosa", video_url = "https://www.youtube.com/embed/EKPAfUCn_Jo?si=jFqCCTyi-TWIJO0X",
    ...
    RecipeItem(id="r-23", title="Poha", video_url = "https://www.youtube.com/embed/LAcFkm5Soq8?si=MLgQpK6bEBxgrRR",
    ...
    # ── Egg & Non-Veg ──
    RecipeItem(id="r-24", title="Egg Curry", video_url = "https://www.youtube.com/embed/CbZxp8bwErM?si=tXrotm5XwSfCscc4",
    ...
    RecipeItem(id="r-25", title="Chicken Curry", video_url = "https://www.youtube.com/embed/zmdp4DmRlIg?si=cZeRCNR_VwkWPk2s",
    ...
    RecipeItem(id="r-26", title="Fish Fry", video_url = "https://www.youtube.com/embed/Wrt7EVxYiF0?si=0siik5HFtySA7J1k",
    ...
    # ── Rice Dishes ──
    RecipeItem(id="r-27", title="Lemon Rice", video_url = "https://www.youtube.com/embed/ovZPQjM_0r0?si=f01EdnxWRUnCLcG9",
    ...
    RecipeItem(id="r-28", title="Jeera Rice", video_url = "https://www.youtube.com/embed/2u3H7JoAm_U?si=TepWXY21N9s3ANiu",
    ...
    # ── Desserts ──
    RecipeItem(id="r-29", title="Gulab Jamun", video_url = "https://www.youtube.com/embed/VVhs1wj9DhU?si=vbiHMsuvoXcR7N31",
    ...
    RecipeItem(id="r-30", title="Kheer", video_url = "https://www.youtube.com/embed/878WHgjtoMo?si=SR7iDAWwfms5Ew9V",
